        ...
        <div className={classes.serviceDetail_wrapper}>
         ...
         <div className={classes.serviceDetail_container}>
           <div className={classes.serviceDetail_main__info}> 
             <div className={classes.serviceDetail_photo}><img src={Exam_data.backImg} alt="nature"  />
             </div>
   
             <h3 className={classes.serviceDetail_subtitle}>{Exam_data.title}</h3>
             ...
             <h3 className={classes.serviceDetail_subtitle}>{Exam_data.subtitle}</h3>
