    ...
    <div className="wrapper">
      <section className="lesenModule_section">
        ...
        <div className="lesenModule_parts">  
            <Link to={`/lesenModule3/lesenPart3_1`}>
              <div className="lesenModule_part">
                ...
                <div className="lesenModule_part_title_wrapper">
                  <h3 className="lesenModule_parts_title">lesen module 3 part 1</h3>
                </div>
              </div>
            </Link>
            <Link to={`/lesenModule3/lesenPart3_2`}>
              <div className="lesenModule_part">
                <img
                  className="lesenModule_backImg"
                  src="https://funart.pro/uploads/posts/2022-08/thumbs/1660179943_53-funart-pro-p-sinii-fon-sport-krasivo-58.jpg"
                ...
                />
                <div className="lesenModule_part_title_wrapper">
                  <h3 className="lesenModule_parts_title">lesen module 3 part 2</h3>
                </div>
              </div>
            </Link>
            <Link to={`/lesenModule3/lesenPart3_3`}>
              <div className="lesenModule_part">
                <img
                  className="lesenModule_backImg"
                  src="https://funart.pro/uploads/posts/2022-08/thumbs/1660179943_53-funart-pro-p-sinii-fon-sport-krasivo-58.jpg"
                ...
                />
                <div className="lesenModule_part_title_wrapper">
                  <h3 className="lesenModule_parts_title">lesen module 3 part 3</h3>
                </div>
              </div>
            </Link>
            <Link to={`/lesenModule3/lesenPart3_4`}>
              <div className="lesenModule_part">
                <img
                  className="lesenModule_backImg"
                  src="https://funart.pro/uploads/posts/2022-08/thumbs/1660179943_53-funart-pro-p-sinii-fon-sport-krasivo-58.jpg"
                ...
                />
                <div className="lesenModule_part_title_wrapper">
                  <h3 className="lesenModule_parts_title">lesen module 3 part 4</h3>
                </div>
              </div>
            </Link>
            <Link to={`/lesenModule3/lesenPart3_5`}>
              <div className="lesenModule_part">
                <img
                  className="lesenModule_backImg"
                  src="https://funart.pro/uploads/posts/2022-08/thumbs/1660179943_53-funart-pro-p-sinii-fon-sport-krasivo-58.jpg"
                ...
                />
                <div className="lesenModule_part_title_wrapper">
                  <h3 className="lesenModule_parts_title">lesen module 3 part 5</h3>
                </div>
              </div>
            </Link>
        </div>
